...
Original file is located at
    https://colab.research.google.com/drive/17nmXTbs_5I2S8rpe2Y-T7dLiiz2da4c1
"""
...
shp_exp = shp_Peru.iloc[[14]]
shp_exp.plot()

Pisco_anom_mensual_Lima = xr_crop(shp_i=shp_exp, netcdf_i=Pisco_anom_mensual)
Pisco_anom_mensual_Lima

shp_exp_grid = xr_shp_to_grid(shp_i = shp_exp, 
                              netcdf_array = Pisco_anom_mensual_Lima.Prec.isel(time=15))


Pisco_anom_masked_Lima = xr_mask(grid_mask = shp_exp_grid,
                             netcdf_i = Pisco_anom_mensual_Lima)

Pisco_anom_masked_Lima

"""# GUARDAR ARCHIVO"""

Pisco_anom_masked_Lima = Pisco_anom_masked_Lima.to_netcdf("Pisco_anom_masked_Lima.nc")

from google.colab import files
files.download("Pisco_anom_masked_Lima.nc")